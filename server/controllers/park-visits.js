...
const initialVisits = [
  {
    ...
    teams: { home: `Diamondbacks`, away: `Rockies` },
  ...
  },
  {
    ...
    teams: { home: `Padres`, away: `Diamondbacks` },
    notes: `It has been a rough season for the Dbacks, but they managed to pull this one through. Embarrassingly, there were some Dbacks fans behind us that also made the trip. They felt the need to heckle the home team. Please don't do this. We sat next to some awesome locals that pointed us to some great craft beer and a BBQ stand behind center field.`,
    rating: 6.5,
  },
  {
    id: 3,
    ...
    notes: `This is the only game I have attended the DBacks didn't play in. We were in Texas for a baseball tournament and have been rained out. We took a day to visit the local team. MM Park is bland. The train feature is ok. Just feels like playing ball in a gym.`,
    rating: 4,
  },
  {
    id: 4,
    ...
    teams: { home: `Orioles`, away: `Diamonbacks` },
    notes: `We did not win, but Baltimore is a beautiful city. This trip has sentimental feeling attached as my dad grew up an Orioles fan and then transitioned to the Dbacks when they were established. He got to meet his idol, Boog Powell. Food was amazing. The fans were great. Can't wait to come back.  `,
    rating: 9.5,
  },
  {
    id: 5,
    ...
    teams: { home: `Tigers`, away: `Diamondbacks` },
